...
**Configure IdeaVim:**
Copy the `ideavimrc` configuration from this repository into the ideavim file generated by Intellij.

> 💡 **Note:** The `.ideavimrc` file must be manually copied as IDE plugins require in-app configuration.
...
├── .ideavimrc       # IdeaVim configuration (copy manually)
└── README.md        # This file
```
